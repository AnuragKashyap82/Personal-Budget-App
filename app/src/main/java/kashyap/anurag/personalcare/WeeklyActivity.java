...
import kashyap.anurag.personalcare.databinding.ActivityWeeklyBinding;
...
public class WeeklyActivity extends AppCompatActivity {
    ...
    private ActivityWeeklyBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityWeeklyBinding.inflate(getLayoutInflater());
    ...
    private void loadAllData() {
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                adapterWeek = new AdapterWeek(WeeklyActivity.this, dataArrayList);
